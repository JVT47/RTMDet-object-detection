...
class GIoULoss(nn.Module):
    ...
    def forward(self, boxes_1: torch.Tensor, boxes_2: torch.Tensor) -> torch.Tensor:
        ...
        enclosure_height = torch.maximum(boxes_1[..., -1], boxes_2[..., -1]) - torch.minimum(boxes_1[..., -3], boxes_2[..., -3])
    ...
    def calc_IoU_and_union(self, boxes_1: torch.Tensor, boxes_2: torch.Tensor) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        I_height = torch.minimum(boxes_1[..., -1], boxes_2[..., -1]) - torch.maximum(boxes_1[..., -3], boxes_2[..., -3])
