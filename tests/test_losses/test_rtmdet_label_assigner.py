...
class TestRTMDetLabelAssigner:
    ...
    def test_make_assigner_matrix_feasible(self) -> None:
        ...
        self.label_assigner._make_assigner_matrix_feasible(assigner_matrix, cost_matrix)
    ...
    def test_simOTA_1(self) -> None:
        ground_truths = BBoxLabelContainer(torch.tensor([[0.0, 0, 1, 1], [7, 7, 9, 9]]), torch.tensor([[0, 0, 1], [1, 0, 0]]))
        bbox_pred = torch.tensor([[0.0, 0.0, 1, 1], [8, 0, 9, 1], [15, -1, 16, 2], [0, 8, 1, 9], [7.5, 7, 9, 9], [16, 8, 17, 9]])
        label_pred = torch.tensor([[0.1, 0.6, 0.9], [0.2, 0.3, 0.4], [0.5, 0.3, 0.2], [0.1, 0.2, 0.3], [0.7, 0.2, 0.2], [0.05, 0.4, 0.3]])
