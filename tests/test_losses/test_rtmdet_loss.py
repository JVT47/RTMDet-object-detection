...
class TestRTMDetLoss:
    ...
    def test_forward_2(self) -> None:
        ...
        gt_1 = BBoxLabelContainer(torch.tensor([[0.5, 6, 1, 8]]), torch.tensor([[1, 0]]))
        gt_2 = BBoxLabelContainer(torch.tensor([[7.0, 7, 10, 10], [30, 30, 34, 34], [0, 0, 1, 1]]), torch.tensor([[1, 0], [0, 1], [0, 1]]))
